...
{/* Las aclamadas---------------------------------------------------------------------------- */}
        ...
        <h2>Aclamadas por la critica</h2> <br></br>
          <div className="top">
...
{/* populares-------------------------------------------------------------------------------- */}
    ...
    <div className="cardPopulares">
      ...
      <div className="content">
        ...
        <p className="parrafoPopular">La serie comienza con la llegada de Penny al apartamento vecino del que comparten Sheldon y Leonard, 2 físicos que trabajan en el Instituto de California. Leonard se enamora desde el primer momento de Penny.</p>
...
{/* segundo contenedor de popular-------------------------------------------------------------- */}
  ...
  <div className="contenedorPopularGeneral2" >
    ...
    <div className="cardPopulares">
      ...
      <div className="content">
        <h3>Friends</h3>
        <p className="parrafoPopular">Monica, Chandler, Phoebe y Joey; donde también se incorporan con el paso de los minutos Ross y por último Rachel. Este encuentro da comienzo a una etapa donde seis amigos viven en la ciudad de Nueva York.</p>
  ...
  <div className="containerPopulares">
    <div className="cardPopulares">
      ...
      <div className="content">
        <h3>Squid Game</h3>
        <p className="parrafoPopular">Cuando muchas personas de escasos recursos y poco dinero se enteran de un lugar que si ganas seras millonario,acceden a dicho lugar; pero descubriran que es un lugar mucho más que horrible.</p>
...
<div className="container__footer">
    ...
    <div className="box__footer">
        ...
        <a href="https://afiliadoxpress.com/funnel/afiliadosexpress/entrenamiento-gratuito/?ref=P71247270E&msclkid=658446e717181cbde22f253a9991dbd3&hsrc=QmluZ291Q0VtYXJrZXRpbmdkaWdpdGFs">App Marketing</a>
        <a href="https://codepen.io/claudiulazar/pen/OdvVOo">IOS Desarrollo</a>
        <a href="https://codepen.io/william-goldsworthy/pen/JzVajj">Android Desarrollo</a>
    </div>
...
<div className="box__copyright">
    <hr/>
    <p>Todos los derechos reservados <b>The seven arth</b></p>
</div>
</footer>
